document.addEventListener('DOMContentLoaded', domReady);
        ...
        function dl3dvSceneEvent(idx) {
            ...
            for (let i = 0; i < imagesLength; i++) {
                ...
                switch (idx) {
                    case 0:
                        image.src = 'resources/360_stmt_clift/0a1b7c20a9';
                        break;
                    case 1:
                        image.src = 'resources/360_stmt_clift/0a485338bb';
                        break;
                    case 2:
                        image.src = 'resources/360_stmt_clift/2b65ba886e';
                        break;
                    case 3:
                        image.src = 'resources/360_stmt_clift/2cbfe28643';
                        break;
                    case 4:
                        image.src = 'resources/360_stmt_clift/165f5af8bf';
                        break;
                    case 5:
                        image.src = 'resources/360_stmt_clift/ba55c875d2';
                        break;
                }
                switch (i) {
                    case 0:
                        image.src = image.src + '_depthsplat.png';
                        break;
                    case 1:
                        image.src = image.src + '_CLiFT25.png';
                        break;
                    case 2:
                        image.src = image.src + '_CLiFT50.png';
                        break;
                    case 3:
                        image.src = image.src + '_CLiFT100.png';
                        break;
                    case 4:
